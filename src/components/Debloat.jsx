...
export function Debloat({ onNavigate }) {
  ...
  return (
    <div className="flex flex-col h-screen bg-black text-white p-4 pb-40">
      ...
      <div className="bg-zinc-900/50 p-3 rounded-xl border border-zinc-800 mb-4 shrink-0 shadow-lg z-10">
          <p className="text-[10px] text-zinc-400 font-mono mb-3 leading-relaxed">Requires root. Modify package states at your own risk. System critical apps are not protected.</p>
          <input 
              type="text" 
